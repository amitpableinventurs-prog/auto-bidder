  ...
  namespace NativeStripeSdkModule {
    struct ConstantsAPI_VERSIONS {
      ...
      struct Builder {
        ...
        using ResultT = ConstantsAPI_VERSIONS;
...
namespace JS {
  namespace NativeStripeSdkModule {
    struct ConstantsSYSTEM_INFO {
      ...
      struct Builder {
        // Backwards compat for RCTTypedModuleConstants
        using ResultT = ConstantsSYSTEM_INFO;
        ...
        struct Input {
          ...
          RCTRequired<bool> isNewArchitecture;
          RCTRequired<NSString *> reactNativeVersion;
        };
...
- (void)addListener:(NSString *)eventType;
- (void)removeListeners:(double)count;
- (facebook::react::ModuleConstants<JS::NativeStripeSdkModule::Constants>)constantsToExport;
- (facebook::react::ModuleConstants<JS::NativeStripeSdkModule::Constants>)getConstants;
...
inline JS::NativeStripeSdkModule::ConstantsSYSTEM_INFO::Builder::Builder(const Input i) : _factory(^{
  ...
  auto isNewArchitecture = i.isNewArchitecture.get();
  d[@"isNewArchitecture"] = @(isNewArchitecture);
  auto reactNativeVersion = i.reactNativeVersion.get();
  d[@"reactNativeVersion"] = reactNativeVersion;
  return d;
}) {}
