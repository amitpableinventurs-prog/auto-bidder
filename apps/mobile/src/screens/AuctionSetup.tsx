...
const styles = StyleSheet.create({
  ...
  carSummary: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', padding: 12, borderRadius: 12, marginBottom: 20 },
  carName: { fontSize: 16, fontWeight: '700', color: DARK },
  carMeta: { fontSize: 12, color: '#64748b', marginTop: 4 },
  sectionLabel: { fontSize: 12, fontWeight: '800', color: '#94a3b8', letterSpacing: 1, marginBottom: 8, marginTop: 4 },
  inputBox: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 2, borderBottomColor: BLUE, paddingVertical: 8, marginBottom: 6 },
  currency: { fontSize: 24, fontWeight: '800', color: DARK, marginRight: 10 },
  input: { fontSize: 24, fontWeight: '800', color: DARK, flex: 1 },
  hint: { fontSize: 12, color: '#64748b', marginBottom: 20, fontStyle: 'italic', lineHeight: 18 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 20 },
  chip: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: '#e2e8f0' },
  chipActive: { backgroundColor: BLUE, borderColor: BLUE },
  chipText: { fontSize: 14, fontWeight: '600', color: '#64748b' },
  chipTextActive: { color: '#fff' },
  infoCard: { flexDirection: 'row', backgroundColor: '#fffbeb', padding: 12, borderRadius: 12, gap: 12, marginTop: 4 },
