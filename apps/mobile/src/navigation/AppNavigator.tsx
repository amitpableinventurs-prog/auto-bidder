...
import * as FAQMod from "../screens/FAQ";
import * as HelpCenterMod from "../screens/HelpCenter";
...
import * as ChooseCarTypeMod from "../screens/ChooseCarType";
import * as NotificationsMod from "../screens/Notifications";
import * as WishlistMod from "../screens/Wishlist";
...
const FAQ = resolve(FAQMod);
const HelpCenter = resolve(HelpCenterMod);
...
const ChooseCarType = resolve(ChooseCarTypeMod);
const Notifications = resolve(NotificationsMod);
const Wishlist = resolve(WishlistMod);
...
export default function AppNavigator() {
  ...
  return (
    <Stack.Navigator id="RootStackNavigator" screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="RtoServices" component={RtoNocModule} />
      <Stack.Screen name="Challans" component={PlaceholderScreen} initialParams={{ title: 'Challans — Check Pending Dues' }} />
      ...
      <Stack.Group>
        ...
        <Stack.Screen name="ChooseCarType" component={ChooseCarType} />
      ...
      <Stack.Group>
        ...
        <Stack.Screen name="AdminAuctions" component={PlaceholderScreen} initialParams={{ title: 'Auction Management' }} />
        <Stack.Screen name="AdminFraud" component={PlaceholderScreen} initialParams={{ title: 'Fraud Detection' }} />
        <Stack.Screen name="AdminPayments" component={PlaceholderScreen} initialParams={{ title: 'Payment Management' }} />
        <Stack.Screen name="AdminReports" component={PlaceholderScreen} initialParams={{ title: 'Reports & Analytics' }} />
        <Stack.Screen name="AdminNotifs" component={PlaceholderScreen} initialParams={{ title: 'Notification Manager' }} />
      </Stack.Group>
    </Stack.Navigator>
  );
}
