...
import { ALL_BRANDS, sortBrandsByPriority, type BrandItem } from '../utils/brands';
...
export default function AllBrands() {
  ...
  const numColumns = SCREEN_W >= 1100 ? 5 : SCREEN_W >= 768 ? 4 : 3;
  const cardWidth = (Math.min(SCREEN_W, 1200) - 32 - ((numColumns - 1) * 12)) / numColumns;
  ...
  const filteredBrands = brands.filter((b: BrandItem) =>
